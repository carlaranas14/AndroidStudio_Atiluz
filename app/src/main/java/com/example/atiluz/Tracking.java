...
public class Tracking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customer_dashboard.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                redirectActivity(Tracking.this, CustomerDashboard.class);
            }
        });
        booking.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                redirectActivity(Tracking.this, Booking.class);
            }
        });
        chat.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                redirectActivity(Tracking.this, Chat.class);
            }
        });
        ...
        contact.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                redirectActivity(Tracking.this, ContactUs.class);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                redirectActivity(Tracking.this, Login.class);
            }
        });
    }
